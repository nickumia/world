...
aws s3 cp static/src/offline/tracker.html s3://offline.kamutiv.com/tracker --content-type "text/html"
aws s3 cp static/src/offline/analytics.html s3://offline.kamutiv.com/analytics --content-type "text/html"
