    ...
    with app.app_context():
        ...
        if nick not in all_users:
            ...
            intro = Posts(id=100,
                          ...
                          subtitle="End of the begining, because there never "
            ...
            with open(filepath+'senses.html', 'r') as f:
                intro_body = f.read()
            senses = Posts(id=101,
                           title="I sense that you sense that ... WE ALL "
                                 "SENSE",
            ...
            identification = Posts(id=102,
                                   title="Sensing the world, No Senses "
                                         "Required... jk!",
            ...
            universalization = Posts(id=103,
                                     title="Be Formless, Shapeless like wa.. "
                                           "no, no, no.. like Senses",
                                     subtitle="How is a sense perceived as a "
                                              "sense?",
                                     body=intro_body,
                                     author=parry)
            ...
            consciousness = Posts(id=105,
                                  ...
                                  subtitle="What is this consciousness idea "
            ...
            processing = Posts(id=997,
                               ...
                               subtitle="Crash into the world of inputs, "
                                        "outputs and foreign object analysis",
                               body=parry_summary,
                               author=parry)
            processing.posted_time = datetime.datetime(2018, 5, 20)
            language = Posts(id=998,
                             title="Lalita's Language",
                             subtitle="Take a deep breath and navigate the "
                                      "subtle realm of transformations",
                             body=lalita_summary,
                             author=lalita)
            language.posted_time = datetime.datetime(2018, 5, 20)
            natural = Posts(id=999,
                            title="Nick's Natural Core",
                            subtitle="Step back, look inward and appreciate "
