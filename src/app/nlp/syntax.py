...
structure = ("The tiniest unit of 'Basic Text' are -->characters<--.  "
             ...
             "idea of -->words<--.  A word is any combination of characters "
...
structure3 = ("In any case, each space-separated -->word<-- has it's own "
              ...
              "-->sentences<--'.  As a neat formula, text can be expressed as "
