...
• The idea is to be able to process the text with an understanding that there is (1) the Intended Meaning and (2) the Perceived Meaning, neither of which may be known at any given time.""",  # NOQA
     "subject": [
        {"type": "Syntax/Grammar",
...
• Think about how many different people pronounce the same words differently ... Think about all of the different accents that exist ... The point is to understand how all of these factors effect a word's meaning.""",  # NOQA
     "subject": [
        {"type": "Phonetics",
         ...
         "key": 1},
        {"type": "Phonology",
         "description": "Using the physical properties to create meaning structures",  # NOQA
         "link": "/coming_soon",
         "key": 2},
        {"type": "Morphology",
...
Without visual knowledge of the world, there is no way a computer would know what "that" refers to.  Granted, with a longer conversation, "that" may become known.  However, a human with vision would have a much different understanding of the conversation.
     ...
     "subject": [
        ...
        {"type": "Object Definitions / Relations",
         "description": "What defines an object, it's functions and properties",  # NOQA
         "link": "/coming_soon",
         "key": 3}
     ]
     }
...
• The end goal is to be able to understand what makes these languages tick, or rather, the mindset of individuals that use each language.
     ...
     "subject": [
        {"type": "Language Structure",
         ...
         "key": 0},
        {"type": "Language Use",
         "description": "Understanding the intended and real use cases of language",  # NOQA
         "link": "/coming_soon",
         "key": 1},
...
• Impossible, you say?  Well, we'll just have to find out (:
     ...
     "subject": [
        {"type": "Generality",
         "description": "How to make languages general enough to include dialects...",  # NOQA
         "link": "/coming_soon",
         "key": 1},
        {"type": "Specialization",
        ...
        {"type": "Known / Unknown Side Effects",
         "description": "What is inherently good or bad about these approaches?",  # NOQA
         "link": "/coming_soon",
         "key": 3}
     ]
     },
...
....By communicating with language?
     ...
     "subject": [
        {"type": "The Self",
         "description": "Understanding what it means to be an object, a person, a thing, a being... an individual unit",  # NOQA
         "link": "/coming_soon",
         "key": 0},
        {"type": "The Group",
         "description": "Understanding how the units identify in relation to other similar and/or different units",  # NOQA
         "link": "/coming_soon",
         "key": 1},
        {"type": "The System",
         "description": "Understanding the process(es) by which units/groups function to find purpose and/or reasoning to exist",  # NOQA
         "link": "/coming_soon",
         "key": 2},
     ],
     },
...
• 
     ...
     "subject": [
        ...
        {"type": "Physical-Metaphysical Interaction",
         "description": "Understanding the complexities of things both physical and intangible",  # NOQA
         "link": "/coming_soon",
         "key": 2},
     ],
     },
    {"key": 2,
     ...
     "phrase": "\"It is important to draw wisdom from many different places\" - Iroh",  # NOQA
     "description": """
