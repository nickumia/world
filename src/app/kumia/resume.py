...
▪ Primary Containerization Developer (Docker, Kubernetes)</br>
▪ Researched DISA STIGs and verified that engineering design met cybersecurity requirements.
""",
     "link": "https://avtsim.com/",
    },
    {"role": "Computer Scientist | Lab Researcher | System Security Engineer | NLP Developer",
     "key": 1,
...
""",
    ...
    {"role": "Founder",
     ...
     "details": "Android App Development (Java) | Website Design | NLP Development",
    ...
    {"role": "Student Instructor / Tutor",
     ...
     "details": "Tutor all levels of undergraduates in mechanical and electrical engineering as well as Mechatronic techniques (Courses include: Calculus I/II, Dynamics, Thermodynamics, Microprocessors, MATLAB). Worked with Professors to give lectures, administer tests and explain class material.",
...
Solidworks, MakerBot, Open-source 3D Printers, G-code, C++ 
""",
    ...
    {"role": "Researcher",
     ...
     "company": "Vaughn College",
     "details": "Studied and completed deep analysis on several mathematical equations such as those that govern the Pendulum as well as Heat Transfer while developing communications skills, working in a team, and Presentation skills (verbalizing/visualizing final results)",
     "link": "https://www.vaughn.edu/",
    },
]
...
educations = [
    {"school": "Hofstra University, Fred DeMatteis School of Engineering and Applied Science",
     "key": 0,
     "date": "2016 - 2018",
